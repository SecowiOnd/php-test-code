		...
		<?php include "includes/header.php"; ?>
			...
			<div class="container">
					...
					<section class="content__left col-md-8">
											...
											<article class="article">
												...
												<div class="article__info">
													...
													<div class="article__info__meta">
														...
														?>
														<small>Категория: <a href="/articles.php?id=<?php echo $art['id']; ?>"><?php echo $cat['title']; ?></a></small>
													</div>
							...
							<div class="block">
							<a href="/articles.php?catigories=7">Все записи</a>
							...
							<div class="block">
							<a href="/articles.php?catigories=4">Все записи</a>
